# iOS Voice Bug Fix (Talk Mode)

## Scope

- Repro: voice input works once then microphone drops; keyboard dictation flow breaks on second attempt
- Fix: stabilize talk recognition lifecycle; ensure mic can restart and dictation can coexist

## Tasks

- [x] Repro via iOS sources/tests (apps/ios)
- [x] Identify root cause in audio session / talk recognition lifecycle
- [x] Implement fix + add tests (VoiceWake/Talk interplay)
- [x] Run iOS tests/lint and capture commands/results
- [x] Commit changes + report
